...
class onboardingModel {
  ...
  onboardingModel({title, required this.imagePath, this.description});
}
...
class faceAndGoogleSignInScreen extends StatelessWidget {
  ...
  const faceAndGoogleSignInScreen({Key? key, required this.RegisterScreen})
      : super(key: key);
...
Widget WelcomeMessageInRegisterScreen(
    {required String mainTitle, String? welcomeMessage, String? detailTitle}) {
  return Column(
    children: [
      Column(
        children: [
...
Widget boxInBoxContainerWidget(String maintext, String titletext,
    Color colorOfBigBox, Color colorOfSmallBox, IconData icon) {
  return Padding(
